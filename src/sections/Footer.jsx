      ...
      <div className="container">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-muted leading-relaxed">
              Passionate MERN stack developer creating modern, responsive, and user-friendly web applications.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-muted text-sm">Copyright {currentYear} Suman Karmakar. All rights reserved.</p>
            <p className="text-muted text-sm">Built with React and modern web technologies</p>
          </div>
        </div>
      </div>
    </footer>
